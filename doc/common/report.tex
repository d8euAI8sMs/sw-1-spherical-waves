...
\begin{document}
    ...
    \section{Ли-вариация, поля, операторы Киллинга}
        ...
        Ли-вариация является обобщением производной по направлению на произвольные тензорные поля. Для произвольного тензорного поля $T(P)$ вводится оператор
        %
        \begin{equation}
            \delta_\xi T(P) = \lim\limits_{\varepsilon \to 0} \frac{
                T(P + \varepsilon \xi) - T(P)
            }{\varepsilon}.
        \end{equation}
        %
        Можно показать, что в пространствах с аффинной связностью без кручения данное определение эквивалентно приведенному ниже.

        Ли-вариацией тензорного поля ${T^{a_1 \dots a_p}}_{b_1 \dots b_q}$ по направлению вектора $\xi$ называется выражение
        %
        \begin{equation}\begin{aligned}
        ...
        \end{aligned}\end{equation}
        %
        Этим вводится понятие коммутатора двух векторных полей или определяемых ими операторов.

        Векторные поля, на которых Ли-вариация метрического тензора равна нулю, называются полями Киллинга:
        %
        \begin{equation}\begin{aligned}
            \delta_\xi g_{ab}
                &= \xi^c \nabla_c g_{ab} + g_{cb} \nabla_{c} \xi^a + g_{ac} \nabla_{c} \xi^a \\
